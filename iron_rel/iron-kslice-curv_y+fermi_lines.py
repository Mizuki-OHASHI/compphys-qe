...
points = np.loadtxt('iron-kslice-coord.dat')
...
bands=np.loadtxt('iron-kslice-bands.dat')
...
outfile = 'iron-kslice-curv_y.pdf'
 
val = np.loadtxt('iron-kslice-curv.dat', usecols=(1,))
